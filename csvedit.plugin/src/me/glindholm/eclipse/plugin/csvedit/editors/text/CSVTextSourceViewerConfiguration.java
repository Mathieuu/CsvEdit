...
class CSVTextSourceViewerConfiguration extends TextSourceViewerConfiguration {
     ...
     */
    public CSVTextSourceViewerConfiguration(final char delimiter, final IPreferenceStore prefStore) {
        super(prefStore);
    ...
    public IPresentationReconciler getPresentationReconciler(final ISourceViewer sourceViewer) {
         ...
         */
        final DefaultDamagerRepairer dr = new DefaultDamagerRepairer(new CSVTokenScanner(m_delimiter));
