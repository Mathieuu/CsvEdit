...
/**
 * This is the contributor class defines in the Editor ContributorClass attribute of the pluging
 * which adds new actions to the workbench menu and toolbar, reflecting the features of the editor
 * type
 *
 * @author fhenri
 *
