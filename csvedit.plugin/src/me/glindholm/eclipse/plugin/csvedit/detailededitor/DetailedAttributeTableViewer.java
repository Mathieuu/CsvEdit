...
public class DetailedAttributeTableViewer {
    ...
    protected List<AttributeRow> model = new ArrayList<>();
     ...
     */
    public void fillTable(final List<String> headers, final List<String[]> content) {
    ...
    private void addRightClickItems(final TableViewer tableViewer) {
        ...
        insertColumnItem.addListener(SWT.Selection, event -> {
            ...
            final List<String> emptyAttributes = new ArrayList<>();
    ...
    public void setModele(final List<AttributeRow> model) {
        this.model = model;
    }
}
